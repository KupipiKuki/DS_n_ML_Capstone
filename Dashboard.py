...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        title=entered_site+' Successful and Failed Launches')
        return fig
...
def update_graphs(entered_site,slider_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(
            ...
            color='Booster Version Category', title='All Sites - Success/Failure by payload',
        ...
        fig = px.scatter(
            ...
            color='Booster Version Category', title=entered_site+'Site - Success/Failure by payload',
            hover_data=['Launch Site'])
        return fig
# Run the app
